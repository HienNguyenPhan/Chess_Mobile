...
class AppDimen {
  ...
  double responsiveDimens({
    ...
    switch (screenType) {
      ...
      case ScreenType.tablet:
        return tablet?.w ??
            ((mobile * DeviceSizeConstants.maxMobileWidth) / DeviceSizeConstants.designDeviceWidth);
  ...
  static ScreenType _getScreenType(double screenWidth) {
    if (screenWidth <= DeviceSizeConstants.maxMobileWidth) {
      return ScreenType.mobile;
    } else if (screenWidth <= DeviceSizeConstants.maxTabletWidth) {
